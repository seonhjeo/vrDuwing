...
public static class VRInput
{
    ...
    public static Vector3 RHandPosition
    {
        get
        {
            ...
            pos = GetTransform().TransformPoint(pos);//월드 포지션으로
            return pos;
#endif
        }
    }
    ...
    public static Vector3 RHandDirection
    {
        get
        {
            ...
            direction = GetTransform().TransformDirection(direction);//월드 디렉션으로
...
# endif
    ...
    public static bool Get(Button virtualMask, Controller hand = Controller.None)
    {
#if PC
        // virtualMask에 들어온 값을 ButtonTarget 타입으로 변환해 전달한다.
        return Input.GetButton(((ButtonTarget)virtualMask).ToString());
#elif Oculus
        if ((OVRInput.Controller)hand == OVRInput.Controller.LTouch)
        {
            return OVRInput.Get((OVRInput.Button)virtualMask, OVRInput.Controller.LTouch);
        }
        else if ((OVRInput.Controller)hand == OVRInput.Controller.RTouch)
        {
            return OVRInput.Get((OVRInput.Button)virtualMask, OVRInput.Controller.RTouch);
        }
        else
        {
            return OVRInput.Get((OVRInput.Button)virtualMask);
        }
    ...
    public static bool GetDown(Button virtualMask, Controller hand = Controller.None)
    {
#if PC
        ...
        if ((OVRInput.Controller)hand == OVRInput.Controller.LTouch)
        {
            return OVRInput.GetDown((OVRInput.Button)virtualMask, OVRInput.Controller.LTouch);
        }
        else if((OVRInput.Controller)hand == OVRInput.Controller.RTouch)
        {
            return OVRInput.GetDown((OVRInput.Button)virtualMask, OVRInput.Controller.RTouch);
        }
        else
        {
            return OVRInput.GetDown((OVRInput.Button)virtualMask);
        }
    ...
    public static bool GetUp(Button virtualMask, Controller hand= Controller.None)
    {
#if PC
        ...
        if ((OVRInput.Controller)hand == OVRInput.Controller.LTouch)
        {
            return OVRInput.GetUp((OVRInput.Button)virtualMask, OVRInput.Controller.LTouch);
        }
        else if ((OVRInput.Controller)hand == OVRInput.Controller.RTouch)
        {
            return OVRInput.GetUp((OVRInput.Button)virtualMask, OVRInput.Controller.RTouch);
        }
        else
        {
            return OVRInput.GetUp((OVRInput.Button)virtualMask);
        }
    ...
    // 컨트롤러의 회전 입력 반환
    public static float GetRotAxis(string axis, Controller hand = Controller.RTouch)
    {
#if PC
        return Input.GetAxis(axis);
#elif Oculus
    ...
    public static void DrawCrosshair(Transform crosshair, bool isHand = true, Controller hand = Controller.RTouch)
    {
        ...
        {
            // 레이의 GetPoint 함수를 이용해 충돌 지점의 위치 get
