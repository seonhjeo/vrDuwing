...
public class Grabber : MonoBehaviour
{
    ...
    {
        // 오른손, 왼손 판단
        if (controller == VRInput.Controller.RTouch)
        {
            handPos = VRInput.RHandPosition;
            handDir = VRInput.RHandDirection;
            handTransform = VRInput.RHand;
        }
        else
        {
            handPos = VRInput.LHandPosition;
            handDir = VRInput.LHandDirection;
            handTransform = VRInput.LHand;
        }
    }
    ...
    void Update()
    {
        VRInput.DrawCrosshair(crosshair,true, controller);
