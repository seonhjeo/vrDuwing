...
namespace Agora_RTC_Plugin.API_Example.Examples.Advanced.CustomCaptureVideo
{
    public class CustomCaptureVideo : MonoBehaviour
    {
        ...
        private Rect _rect;
        public WebCamTexture _webCameraTexture;
        ...
        internal static string _tokenBase = "http://agora-token-service-production-d6cb.up.railway.app";
        internal CONNECTION_STATE_TYPE _state = CONNECTION_STATE_TYPE.CONNECTION_STATE_DISCONNECTED;

        public static GameObject CaptureVideo;
        ...
        private IEnumerator ShareScreen()
        {
            ...
            if (rtc != null)
            {
                ...
                //Debug.Log("PushVideoFrame ret = " + sret + "time: " + System.DateTime.Now.Millisecond);
            }
        }
        ...
        public void JoinChannel()
        {
            ...
            Debug.Log("channel token : " + _channelToken);
            Debug.Log("channel name : " + _channelName);
            //추가 작성
            if (!ReferenceEquals(CaptureVideo, null))
            {
                Debug.Log("In go obj");
                CaptureVideo.SetActive(true);
                CaptureVideo.GetComponent<VideoSurface>().SetEnable(true);
            }
            RtcEngine.JoinChannel(_channelToken, _channelName, "");
        }
        internal void RenewOrJoinToken(string newToken)
        {
            CustomCaptureVideo._channelToken = newToken;
        ...
        {
            RtcEngine.RenewToken(CustomCaptureVideo._channelToken);
        }
        ...
        private void InitCameraDevice()
        {
            ...
            RawImage.texture = gameCam.targetTexture;
        }
        ...
        {
            GameObject go = Instantiate(AgoraManager.Instance.screenPrefab);
            if (go == null)
            {
                Debug.Log("!!!!!!!!!!!! ");
                return null;
